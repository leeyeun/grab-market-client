    ...
    return (
        <div id="upload-container">
            <Form name="상품 업로드" onFinish={onSubmit} >
                ...
                >
                    <InputNumber defaultValue={0} className="upload-price" size="large" ></InputNumber>
                </Form.Item>
                <Divider></Divider>
                <Form.Item 
                name="description"
                label={<div className="uploda-label">상품 소개</div>}
                rules={[{required : true, message : "상품 소개를 입력해주세요."}]}>
                    <Input.TextArea 
                    size="large" 
                    id="product-description" 
                    showCount maxLength={300}
                    placeholder="상품소개를 적어주세요."></Input.TextArea>
                </Form.Item>
                <Form.Item>
